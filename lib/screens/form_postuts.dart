...
class FormPostUts extends StatefulWidget {
  const FormPostUts({Key? key}) : super(key: key);

  @override
  _FormPostUtsState createState() => _FormPostUtsState();
}

class _FormPostUtsState extends State<FormPostUts> {
  ...
  Future<void> _postDataWithImage(BuildContext context) async {
    ...
    var request = MultipartRequest('POST', Uri.parse(Endpoint.datasuts));
    ...
    request.send().then((response) {
      ...
      if (response.statusCode == 200) {
        ...
        Navigator.pushReplacement(
            context, MaterialPageRoute(builder: (context) => Testuts()));
      } else {
